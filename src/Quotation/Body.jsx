  ...
  return (
    <div className="w-[100%] mt-2">
      <table className="text-[30px] w-[100%]">
        <tr>
          <th className="border-2 border-black w-10">S.no</th>
          <th className="border-2 border-black w-[70px]">Item</th>
          <th className="border-2 border-black w-[700px]">Description</th>
          <th className="border-2 border-black  w-[50px]">Qty</th>
          <th className="border-2 border-black  w-[100px]">Unit Price</th>
          <th className="border-2 border-black w-[120px]">Total Price</th>
        </tr>
        <tr className="text-[20px]">
          <td className="border-2 border-black text-center">1</td>
          <td className="border-2 border-black text-center">SS</td>
          <td className="border-2 border-black text-left px-1">
          ...
          <td className="border-2 border-black text-center">15140</td>
          <td className="border-2 border-black text-center">300000</td>
        </tr>
        <tr className="text-[20px]">
          <td className="border-2 border-black text-center">1</td>
          <td className="border-2 border-black text-center">SS</td>
